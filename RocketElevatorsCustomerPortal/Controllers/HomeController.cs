...
namespace RocketElevatorsCustomerPortal.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(matthewdandurandContext context, UserManager<RocketElevatorsCustomerPortalUser> userManager, ILogger<HomeController> logger, IFlashMessage flashMessage)
        {
